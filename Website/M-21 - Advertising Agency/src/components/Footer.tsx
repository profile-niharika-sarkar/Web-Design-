    ...
    <footer className="py-16 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {/* Column 3 */}
          <div className="relative flex flex-col items-justify md:items-start text-justify md:text-left ml-00">
            <div className="flex flex-wrap justify-start gap-3 mb-6 w-full">
              <a
                href="https://outdoor.m21world.com/"
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-500 to-teal-600 text-white font-bold uppercase text-sm whitespace-nowrap"
              >
                Outdoor Media
              </a>
